...
import { openEditHandler, __DeleteBody, __EditBody, __thatMatchPosts } from '../redux/modules/match'
                  ...
                  <MatchPost key={item.commentId}>
                    <div style={{display:'flex', gap:'80px'}}>
                      ...
                      <div style={{display:'flex', flexDirection:'column', justifyContent:'center'}}>
                        <div style={{fontSize:'17px', marginBottom:'10px',width: '500px'}}>{item.body}</div>
                        <span style={{fontSize:'11px'}}> 작성시간 : {item.createdAt}</span> 
                        <span style={{fontSize:'11px'}}> 수정시간 : {item.modifiedAt}</span>
                      </div>
                    </div>
